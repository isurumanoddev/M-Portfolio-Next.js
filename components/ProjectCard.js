    ...
    return (
        <article
            ...
            <motion.img
                ...
                alt=""/>
            <div className={"px-0 md:px-10 flex flex-col gap-3 pb-3 text-center"}>
                ...
                <div className={"flex flex-row flex-wrap gap-3.5 px-2"}>

                    <p className={"px-4 py-1.5 font-semibold text-[17px] bg-[#64FFDA]/80 text-[#0a1029] rounded-full w-fit "}>Javascript</p>
                    <p className={"px-4 py-1.5 font-semibold text-[17px] bg-[#64FFDA]/80 text-[#0a1029] rounded-full w-fit "}>React</p>
                    <p className={"px-4 py-1.5 font-semibold text-[17px] bg-[#64FFDA]/80 text-[#0a1029] rounded-full w-fit "}>React</p>
                    <p className={"px-4 py-1.5 font-semibold text-[17px] bg-[#64FFDA]/80 text-[#0a1029] rounded-full w-fit"}>Next
                        js</p>
                    <p className={"px-2 py-1 font-semibold text-[15px] bg-[#64FFDA]/80 text-[#0a1029] rounded-full w-fit"}>Next
                        js</p>
                </div>
